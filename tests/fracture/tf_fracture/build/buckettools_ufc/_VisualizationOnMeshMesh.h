...
#ifndef ___VISUALIZATIONONMESHMESH_H
#define ___VISUALIZATIONONMESHMESH_H
...
class _visualizationonmeshmesh_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  _visualizationonmeshmesh_finite_element_0();

  /// Destructor
  virtual ~_visualizationonmeshmesh_finite_element_0();
...
class _visualizationonmeshmesh_dofmap_0: public ufc::dofmap
{
public:

  /// Constructor
  _visualizationonmeshmesh_dofmap_0();

  /// Destructor
  virtual ~_visualizationonmeshmesh_dofmap_0();
...
class _visualizationonmeshmesh_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  /// Constructor
  _visualizationonmeshmesh_cell_integral_0_otherwise();

  /// Destructor
  virtual ~_visualizationonmeshmesh_cell_integral_0_otherwise();
...
class _visualizationonmeshmesh_form_0: public ufc::form
{
public:

  /// Constructor
  _visualizationonmeshmesh_form_0();

  /// Destructor
  virtual ~_visualizationonmeshmesh_form_0();
...
namespace _VisualizationOnMeshMesh
{
...
public:
  ...
  Form_a_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new _visualizationonmeshmesh_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new _visualizationonmeshmesh_dofmap_0()), mesh)))
  {
    // Do nothing
  }
  ...
  Form_a_FunctionSpace_0(std::shared_ptr<const dolfin::Mesh> mesh, std::shared_ptr<const dolfin::SubDomain> constrained_domain):
    dolfin::FunctionSpace(mesh,
                          std::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::shared_ptr<ufc::finite_element>(new _visualizationonmeshmesh_finite_element_0()))),
                          std::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::shared_ptr<ufc::dofmap>(new _visualizationonmeshmesh_dofmap_0()), *mesh, constrained_domain)))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = std::shared_ptr<const ufc::form>(new _visualizationonmeshmesh_form_0());
  }
